...
public class LevelDesigner_Master : Editor
{
    ...
    [MenuItem("My Commands/First Command #TAB")]
    ...
    static void OnSceneGUI(SceneView sceneView)
    {
        ...
        if (e.button == 1 && e.control && !e.shift)
        {
            if (e.type == EventType.MouseDown)
            {
                ...
                if (Selection.count > 1) { menu.AddItem(new GUIContent("Group"), false, Group, 1); } else { menu.AddDisabledItem(new GUIContent("Group"), false); }
